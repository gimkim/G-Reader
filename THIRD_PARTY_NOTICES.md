...
- License copies: `licenses/APACHE-2.0-PDFIUMCORE.md` and
  `licenses/PDFIUM-BSD.md`

The license files above must accompany source and binary distributions that
include these components. Do not remove or obscure their copyright, trademark,
attribution, or warranty notices.
